<?php
// landing page — public homepage with system info and stats
$pageTitle = 'Home';
...
<div class="hero-section text-center">
    <div class="container">
        ...
        <?php if (!isLoggedIn()): ?>
        <div class="mt-4">
            <a href="<?= APP_URL ?>/modules/auth/register.php" class="btn btn-light btn-lg me-2 fw-bold"><i class="fas fa-user-plus me-2"></i>Register Now</a>
            <a href="<?= APP_URL ?>/modules/auth/login.php" class="btn btn-outline-light btn-lg"><i class="fas fa-sign-in-alt me-2"></i>Login</a>
        </div>
        <?php else: ?>
        <div class="mt-4">
            <?php $r=currentUserRole(); $d=$r==='donor'?'/modules/donor/dashboard.php':($r==='hospital'?'/modules/hospital/dashboard.php':'/modules/admin/dashboard.php'); ?>
    ...
    <div class="card-body p-4">
        ...
        <div class="table-responsive">
            <table class="table table-bordered text-center mb-0">
                <thead><tr><th>Recipient</th><th>Can Receive From</th></tr></thead>
                <tbody>
...
<div class="row justify-content-center mb-5"><div class="col-md-8">
<?php $faqs = [
    ['Who can donate blood?','Most healthy adults aged 18-65 weighing over 50kg can donate. You must wait at least 12 weeks (90 days) between donations.'],
    ['How long does a donation take?','The actual blood draw takes about 10 minutes. The entire visit including registration and a short rest takes 30-45 minutes.'],
    ['Is my data safe?','Yes. We only store area-level location (not exact coordinates). All passwords and security answers are encrypted with industry-standard hashing.'],
    ['How does matching work?','When a hospital posts a blood request, compatible donors in the same country are found based on blood type compatibility and distance from the hospital area.'],
    ['What happens after I book?','The hospital will review your booking and confirm or reschedule. You will receive a notification when your booking status changes.'],
    ['Can hospitals see my exact address?','No. Hospitals only see your area (e.g., Baneshwor). Your exact address is never shared.'],
    ['Why am I marked as ineligible?','After donating, you are automatically set as ineligible for 12 weeks (90 days) for your safety. Your next eligible date is shown on your dashboard.'],
]; foreach ($faqs as $i => $f): ?>
<div class="card mb-2"><div class="card-body py-3 px-4">
    <div class="d-flex justify-content-between align-items-center" style="cursor:pointer" onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display==='none'?'block':'none'">
        <strong><?=e($f[0])?></strong><i class="fas fa-chevron-down text-muted"></i>
    </div>
...
<div class="text-center mb-5">
    ...
    <a href="<?=APP_URL?>/contact.php" class="btn btn-blood"><i class="fas fa-envelope me-2"></i>Contact Us</a>
</div>
