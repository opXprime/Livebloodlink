...
// If country selected, preload its cities
$cities = [];
...
<div class="row g-3">
    <div class="col-md-4">
        ...
        <select class="form-select" id="loc_country" name="country_id" <?= $req ?>>
            ...
            <option value="<?= $c['id'] ?>" <?= ($selectedCountryId ?? 0) == $c['id'] ? 'selected' : '' ?>><?= e($c['name']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="col-md-4">
        ...
        <select class="form-select" id="loc_city" name="city_id" <?= $req ?>>
            ...
            <option value="<?= $ct['id'] ?>" <?= ($selectedCityId ?? 0) == $ct['id'] ? 'selected' : '' ?>><?= e($ct['name']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="col-md-4">
